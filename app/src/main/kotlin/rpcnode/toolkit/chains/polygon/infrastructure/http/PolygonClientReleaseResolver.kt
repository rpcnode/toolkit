...
/**
 * Latest bor tag from GitHub. Heimdall keeps its own GitHub source in `clients/polygon.yml`.
 */
class PolygonClientReleaseResolver(
...
) : ClientReleaseResolver
{
    ...
    companion object
    {
        const val REPO = "0xPolygon/bor"
        private val ENVS = setOf(EnvId.MAINNET, EnvId.AMOY)
    }
}
