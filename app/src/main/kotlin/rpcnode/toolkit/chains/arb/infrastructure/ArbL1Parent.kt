...
/**
 * Resolves Ethereum L1 execution RPC + beacon for Nitro parent chain.
...
object ArbL1Parent
{
    ...
    fun publicDefaults(arbEnv: String): Endpoints?
    {
        return when (ArbClusters.l1Env(arbEnv))
        {
    ...
    {
        val l1 = ArbClusters.l1Env(arbEnv)
        val local = localEthereum(l1)
        val pub = publicDefaults(arbEnv)
