...
func resolveXRPLHistoryPolicy(etc string) xrplHistoryPolicy {
...
func xrplHistoryOK(env string, lo, hi, seq int64, pol xrplHistoryPolicy) bool {
	...
	return hi-lo+1 >= int64(pol.Ledgers)
}
